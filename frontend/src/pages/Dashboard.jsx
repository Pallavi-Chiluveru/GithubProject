  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] font-sans selection:bg-[#1f6feb]/30 transition-colors">
      ...
      <div className="flex">
        ...
        <aside className="hidden lg:block w-[320px] flex-shrink-0 sticky top-16 h-[calc(100vh-64px)] overflow-y-auto border-r border-[var(--border-color)] bg-[var(--bg-primary)] custom-scrollbar">
          <AccountPanel />
        </aside>
